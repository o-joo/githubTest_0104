...
<%	
	  ...
	  int start=12; //디비의 select 시작번호
	  int end=18; //시작번호로 부터 가져올 select 갯수
                ...
                <div class="main_1">
                    ...
                    <div class="nv">
                        <span class="nv_s">
                            ...
                            <div class="p_1">
                                <p><a href="../trip/trip.jsp">제주도에가면</a> &nbsp 〉&nbsp <a href="#"><span style="font-weight: bold;">도보여행</span></a></p>
                            </div>
                        </span>
                    </div>
                    <!--메인 네비 끝-->
